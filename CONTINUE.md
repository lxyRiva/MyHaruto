...
- 当前阶段：**RF-P3b 已提交（66480d2，三报告通过，App 316 行）；RF-P3c（日期收口+useLocalStorage+L1排序，P3 收官段，含已拍板的 album/travel 入口行为）已派发；bug 池 10 项在 RF-Fix4（P6b 后）；RF-P7 设置中心（Fix4 后，v1.0.0 收官随其后）**。后续循环以 docs/REFACTOR_CARDS.md 为准。
